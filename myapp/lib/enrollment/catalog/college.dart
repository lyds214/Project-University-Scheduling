      ...
      children: <Widget> [
        ...
        Container(
          ...
          child: GridView.extent( // Creates college of business classes
            ...
            children: collegeBusiness.map((string) => _buildSubjectCard(string)).toList(), //prints out the class subjects and acronyms on the cards.
          ),
        ),
        ...
        Container(
         ...
         Container(
          height: 900,
          padding: EdgeInsets.fromLTRB(26, 40, 10, 10),
          child: GridView.extent( // Creates college of education classes
            padding: EdgeInsets.all(10.0),
            childAspectRatio: (425/300),
            maxCrossAxisExtent: 425.0,
            children: collegeEducation.map((string) => _buildSubjectCard(string)).toList(), //prints out the class subjects and acronyms on the cards.
          ),
        ),
